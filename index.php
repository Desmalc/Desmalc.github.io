                ...
                <div class="modal-dialog modal-lg" role="content">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="form-group row">
                                    <label for="inlineRadioOptions" class="col-12 col-sm-3 col-form-label">
                                ...
                                <div class="form-group row">
                                    <label for="dateTime" class="col-12 col-sm-3 col-form-label">
                        ...
                        <div class="modal-footer">
                            <div class="form-row">
                                <button type="button" class="btn btn-secondary btn-sm ml-auto" data-dismiss="modal">Cancel</button>
                                <button type="submit" class="btn btn-primary btn-sm ml-1">Request</button>
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <div class="row row-content">
        <div class="col-lg-10 col mx-auto">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <!--left and right controls of the caroysel-->
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
          ...
          <h4>
            <strong>Web Applications Design and Development</strong>
          </h4>
          <p class="text-faded mb-0">We build all types dynamic websites and web Applications including E-commerce sites for our esteemed clients</</p>
        </div>
        <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
          <span class="service-icon rounded-circle mx-auto mb-3">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <h4>
            <strong>Web Upgrade and Maintenance Services</strong>
          </h4>
          <p class="text-faded mb-0">We provide web maintenance services for all kinds of websites and web applications(we charge discounted service fee(s) for maintenance and upgrade of web sites/apps designed and developed by our staff)</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="content-section" id="portfolio">
    <div class="container">
      ...
      <div class="row no-gutters">
        <div class="col-lg-6">
          <a class="portfolio-item" href="https://lady-lilac-stores.business.site">
            <div class="caption">
        ...
        <div class="col-lg-6">
          <a class="portfolio-item" href="https://desmalcng.online">
            <div class="caption">
              <div class="caption-content">
                <div class="h2">Desmalcng.online</div>
